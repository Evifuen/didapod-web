...
# --- 3. MOTOR DE LIMPIEZA (PARA MATAR EL ERROR 5) ---
...
# --- 4. LOGIN Y REGISTRO DE USUARIOS ---
...
# --- 5. INTERFAZ Y DOBLAJE ---
st.title("🎙️ DIDAPOD PRO")
st.write(f"Active Session: **{st.session_state['user_email']}**")
