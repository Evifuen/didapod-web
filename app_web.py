    ...
    if st.button("🚀 START AI DUBBING PROCESS"):
        try:
            with st.spinner("🤖 AI is processing your audio..."):
                ...
                # --- MODIFICACIÓN PARA QUITAR EL ERROR ---
                t_cfg = speechsdk.translation.SpeechTranslationConfig(subscription=AZ_KEY, region=AZ_REG)
                
                # 1. ESENCIAL: Decirle a Azure que el audio original está en español (o auto-detectar)
                ...
                if res.reason == speechsdk.ResultReason.TranslatedSpeech:
                    ...
                    # Mensaje detallado para saber POR QUÉ falla exactamente
                    st.error(f"Azure Error: {res.reason}")
